...
def build_records(dataset_config: Path, *, session_id_patterns: list[str] | None = None) -> tuple[list[dict[str, Any]], dict[str, Any]]:
...
def main() -> None:
    args = parse_args()
    rows, summary = build_records(args.dataset_config, session_id_patterns=list(args.session_id_pattern or []))
