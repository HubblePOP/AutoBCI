...
def stage_runs(args: argparse.Namespace) -> list[dict[str, object]]:
    ...
    return [
        ...
        {
            "run_id": "stageD_upper_bound_lmp_hg_feature_gru",
            "script": "train_feature_lstm.py",
            "dataset_config": args.upper_bound_config,
            "signal_preprocess": "car_notch_bandpass",
            "feature_family": "lmp+hg_power",
        ...
        {
            "run_id": "stageD_upper_bound_lmp_hg_feature_tcn",
            "script": "train_feature_lstm.py",
            "dataset_config": args.upper_bound_config,
            "signal_preprocess": "car_notch_bandpass",
            "feature_family": "lmp+hg_power",
            ...
            results.append(
                {
                    "run_id": run["run_id"],
                    "status": "skipped",
                    "reason": "Pass --run-feature-lstm to include feature-sequence runs.",
                }
            )
            continue
