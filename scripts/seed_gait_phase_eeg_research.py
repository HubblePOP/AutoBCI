...
QUERY_SPECS = [
    {
        "query": "gait EEG stance swing timing window length",
        "intent": "找步态脑电二分类里窗长怎么选，优先看固定窗口长度对支撑/摆动区分的影响。",
    },
    {
        "query": "gait EEG premovement timing decoding fixed lag",
        "intent": "找脑电提前于动作的证据，帮助这轮固定全局时延扫描。",
    },
    {
        "query": "EEG gait phase decoding support swing window size",
        "intent": "找支撑/摆动任务的窗口大小经验，判断 0.5s 到 3.0s 哪些范围更有希望。",
    },
    {
        "query": "fixed-lag decoding gait EEG support swing classification",
        "intent": "找固定 lag 解码的直接先例，帮助判断 0/100/250/500ms 是否合理。",
    },
]
